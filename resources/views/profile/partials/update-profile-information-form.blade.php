<section>
    ...
    <div class="flex flex-col md:flex-row gap-5 mt-6">
        <form method="post" action="{{ route('profile.update') }}" class="mt-6 lg:w-1/2 space-y-6">
            @csrf
            @method('patch')
            ...
            <div class="w-full">
                ...
                <div class="relative">
                    ...
                    <x-text-input datepicker type="text" id="date" name="birthday"
                                  ...
                                  class="mt-1 block w-full pl-10 pr-4 py-2.5 rounded-lg focus:ring-blue-500 focus:border-blue-500 border border-gray-300 text-gray-900 text-sm dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <div class="w-full lg:w-1/2 mt-6 ">
            <img src="{{ asset($user->profile_photo) }}" alt="Profile Photo"
                 class="w-full h-96 md:h-5/6 rounded-xl object-cover">
        </div>
    </div>
