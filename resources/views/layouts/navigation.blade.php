<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <div class="transition duration-300 w-14 h-14 transform hover:scale-110">
                            <a href="/">
                                <x-application-logo class="w-20 h-20 z-0 fit-current" />
                            </a>
                        </div>
                    </a>
                </div>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <img class="h-11 w-11 rounded-full object-cover mr-2 transition duration-300 transform hover:scale-125"
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('users.employees')" :active="request()->routeIs('users.employees')">
                <i class="fa fa-user-tie mr-2"></i>
                {{ __('Employees table') }}
            </x-responsive-nav-link>
        </div>
