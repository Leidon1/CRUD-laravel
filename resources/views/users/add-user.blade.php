            ...
            <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="flex flex-row justify-between ">
                    ...
                    <button type="button" id="close-modal"
                            class="z-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white rounded-full items-center text-white bg-red-500 hover:bg-red-800 w-10 h-10">
