<form method="POST" id="add-user-form" action="{{ route('users.store') }}">
    ...
    <div class="w-full flex justify-between gap-3">
        ...
        <div class="w-full md:w-1/2">
            ...
            <x-text-input id="name" class="block mt-1 w-full rounded-full" type="text" name="name" :value="old('name')"
    ...
    <div class="flex justify-between gap-3">
        ...
        <div class="mt-4 w-full md:w-1/2">
            ...
            <x-select-input id="gender" name="gender" class="block mt-1 w-full rounded-full" :value="old('gender')">
        ...
        <div class="mt-4 w-full md:w-1/2">
            ...
            <x-select-input id="country" name="country" class="block mt-1 w-full rounded-full" :value="old('country')">
    ...
    <div class="relative mt-4 w-full">
        ...
        <div class="relative">
            ...
            <x-text-input datepicker type="text" id="birthday" name="birthday" :value="old('birthday')"
    ...
    <div class="flex justify-between gap-3">
        ...
        <div class="mt-4 w-full md:w-1/2">
            ...
            <x-select-input id="role" name="role" class="block mt-1 w-full rounded-full" :value="old('role')">
        ...
        <div class="mt-4 w-full md:w-1/2">
            ...
            <x-select-input id="sub_roles" name="sub_roles" class="block mt-1 w-full rounded-full"
                            :value="old('sub_roles')">
