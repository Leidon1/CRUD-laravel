                            ...
                            <form method="POST" id="edit-user-form"
                                ...
                                <div class="w-full flex justify-between gap-3">
                                    ...
                                    <div class="w-full md:w-1/2">
                                        ...
                                        <x-text-input id="edit-last_name" class="block mt-1 w-full rounded-full"
                                                      type="text"
                                                      name="last_name"
                                                      :value="old('last_name')"
                                ...
                                <div class="relative mt-4 w-full">
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input datepicker datepicker-format="yyyy/mm/dd" datepicker-autohide datepicker-buttons datepicker-autoselect-today type="text" id="edit-birthday" name="birthday"
                                                      :value="old('birthday')"
                                ...
                                <div class="flex justify-between gap-3">
                                    ...
                                    <!-- Confirm Password -->
                                    <div class="mt-4 w-full">
                                        <x-input-label for="edit-password_confirmation"
